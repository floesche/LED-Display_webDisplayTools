...
Hardware references: [Cree XLamp XP-E2 LED data
sheet](https://downloads.cree-led.com/files/ds/x/XLamp-XPE2.pdf) and
[LUXdrive 3021/3023 BuckPuck data
sheet entry](https://leddynamics.com/products?id=4&pdf=3021_3023-BuckPuck.pdf).
The per-rig optical power calibration and final LED percent-to-brightness table
still require instructor measurements.
